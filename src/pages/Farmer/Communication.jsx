...
function Communication({ initialStudentName }) {
  const students = [
    {
      name: "Sirisha Rao",
  ...
  const initialIndex = initialStudentName
    ? Math.max(0, students.findIndex((s) => s.name.toLowerCase() === initialStudentName.toLowerCase()))
    : 0;

  const [selectedStudent, setSelectedStudent] = useState(initialIndex);
